...
/**
 * ( 创建新的会话，销毁会话，并提供接收XML) This class is to create new sessions, destroy
 * sessions and deliver received XML stanzas to the StanzaHandler.
 *
