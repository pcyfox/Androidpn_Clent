...
/**
 * (用户认证管理 ) This class is to provide the methods associated with user
 * authentication.
 *
...
public class AuthManager {
	...
	/**
	 * Authenticates a user with a username and plain text password, and returns
	 * an AuthToken.
	 * 
	 * @param username
	 *            the username
