...
/**
 * (用来维护client的在线状态) This class is to manage the presences of users.
 * 
...
public class PresenceManager {
	...
	public boolean isAvailable(User user) {
		...
		Session session = sessionManager.getSession(user.getUsername());
		return session == null;
	}
	 ...
	 * 
	 * */
	public boolean booleanConnect(User user) {
