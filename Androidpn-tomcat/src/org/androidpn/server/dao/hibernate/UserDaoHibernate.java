...
public class UserDaoHibernate extends HibernateDaoSupport implements UserDao {
	...
	@SuppressWarnings("unchecked")
	public List<User> getUserByRealName(String realName) throws UserNotFoundException {
		@SuppressWarnings("rawtypes")
		List users = getHibernateTemplate().find("from User where name=?",
				realName);
		if (users == null || users.isEmpty()) {
			throw new UserNotFoundException("木有找到 '" + realName + "' 这个娃！！");
		} else {
			return  users;
		}
